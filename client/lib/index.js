...
function resolve(test) {
    let graph = test.question[0].graph, canvas = document.getElementById("canvas"), list = document.getElementById("list"), letter = graph[0].funcType, height = canvas.height, width = canvas.width;

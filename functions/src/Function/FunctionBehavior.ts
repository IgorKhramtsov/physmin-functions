...
let FunctionBehavior = {
    ...
    // Changes function parameters so that the START of the function falls into one of the grid nodes
    snapEnd(this: any): FunctionObj {
    ...
    // Changes function parameters so that the END of the function falls into one of the grid nodes
    snapBegin(this: any): FunctionObj {
        const funcObj = this.functionObj,
        funcType = funcObj.funcType,
            params = funcObj.params;
    ...
    isConvex(this: any, start: number = 0, end: number = 4): boolean {
        const funcObj = this.functionObj,
            params = funcObj.params,
